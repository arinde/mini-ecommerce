...
export default function SuccessPage() {
  ...
  return (
    <main className="container mx-auto p-4 md:p-8 max-w-xl text-center flex flex-col items-center justify-center min-h-[calc(100vh-120px)]"> {/* Adjust min-h if you have a fixed header/footer */}
